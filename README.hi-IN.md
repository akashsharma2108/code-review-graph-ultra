...
```bash
pip install code-review-graph-ultra                     # या: pipx install code-review-graph-ultra
...
```bash
pip install "code-review-graph-ultra[embeddings]"          # लोकल वेक्टर एम्बेडिंग (sentence-transformers)
pip install "code-review-graph-ultra[google-embeddings]"   # Google Gemini एम्बेडिंग
pip install "code-review-graph-ultra[communities]"         # कम्युनिटी डिटेक्शन (igraph)
pip install "code-review-graph-ultra[enrichment]"          # Python call-resolution enrichment (Jedi)
pip install "code-review-graph-ultra[eval]"                # मूल्यांकन बेंचमार्क (matplotlib)
pip install "code-review-graph-ultra[wiki]"                # LLM सारांश के साथ विकी जनरेशन (ollama)
pip install "code-review-graph-ultra[all]"                 # सभी वैकल्पिक डिपेंडेंसीज़
```
